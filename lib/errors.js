...
Errors.prototype = {
    ...
    /**
     * Assertion: there should be no space between given tokens.
     *
     * @param {Object} token
     ...
     */
    disallowSpaceBetween: function(token, nextToken, message, disallowNewLine) {
    ...
    /**
     * Assertion: there should be at least one space between given tokens.
     *
     * @param {Object} token
     * @param {Object} nextToken
     * @param {String} message
     */
    requireSpaceBetween: function(token, nextToken, message) {
        if (nextToken.range[0] === token.range[1]) {
            this._errorList.push({
                message: message,
                line: token.loc.end.line,
